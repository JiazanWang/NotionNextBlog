...
const LayoutSlug = props => {
  ...
  return (
    <>
      <div
        className={`article h-full w-full ${fullWidth ? '' : 'xl:max-w-3xl mx-auto'} ${hasCode ? 'xl:w-[55vw] xl:mx-auto' : ''}  bg-white dark:bg-[#18171d] dark:border-gray-600 lg:hover:shadow lg:border rounded-2xl lg:px-2 lg:py-4 `}>
        {/* 文章锁 */}
