...
module.exports = {
  ...
  POSTS_SHARE_SERVICES:
    ...
    'link,wechat,qq,weibo,email,facebook,twitter,telegram,messenger,reddit,linkedin', // 分享的服務，按顺序显示,逗号隔开
  ...
  POSTS_PER_PAGE: process.env.NEXT_PUBLIC_POST_PER_PAGE || 11, // post counts per page
